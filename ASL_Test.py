...
while(cap.isOpened()):
    ...
    img = cv2.flip(img,1)
    cv2.rectangle(img,(420,44),(620,300),(255,0,0),3) # bounding box which captures ASL sign to be detected by the system
    img1=img[44:300,420:620] #44,221,300,433.28
    #print(img1)
    #print (img1 is None)
        ...
        if(label!=None):
            ...
            if(temp==40):
                ...
                if(label=='QQQ'):
                    ...
                    #text=previousText
                print(text)
        cv2.putText(gesture,label,(50,150),font,8,(0,125,155),2)        
